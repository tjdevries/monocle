$ externally tagged variant
  ...
  let () =
    ...
    Format.printf "[%s,%s]\n%!" json1 json2
  File "variant_externally_tagged_test.ml", line 1, characters 4-11:
  1 | [@@@warning "-37"]
          ^^^^^^^
  Warning 53 [misplaced-attribute]: the "warning" attribute cannot appear in this context
...
$ adjacently tagged variant
  ...
  let () =
    ...
    let json2 = (Serde_json.to_string serialize_ranks value) |> Result.get_ok in
    Format.printf "[%s,%s]\n%!" json1 json2
  File "variant_adjacently_tagged_test.ml", line 1, characters 4-11:
  1 | [@@@warning "-37"]
          ^^^^^^^
  Warning 53 [misplaced-attribute]: the "warning" attribute cannot appear in this context
